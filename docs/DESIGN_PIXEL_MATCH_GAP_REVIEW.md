...
**Khớp: ~50%.** Đây là màn lệch nhiều nhất về *anatomy của row*.
...
16. **GP1** Card "On track" mint — *cần bàn:* schema chưa có tổng tín chỉ chương trình, phải thêm field hoặc suy ra từ dữ liệu khác
